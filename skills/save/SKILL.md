...
- **cli** — `obsidian-cli create path="$NOTE" content="…" overwrite` (prefer filesystem Write for a full session note — no stdin/`write` command); see [`skills/wiki-cli/SKILL.md`](../wiki-cli/SKILL.md)
