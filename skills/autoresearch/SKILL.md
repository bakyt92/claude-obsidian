...
- **cli** — `obsidian-cli create path="$NOTE" content="…" overwrite` (small notes; prefer filesystem Write for large bodies — no stdin/`write` command); see [`skills/wiki-cli/SKILL.md`](../wiki-cli/SKILL.md)
